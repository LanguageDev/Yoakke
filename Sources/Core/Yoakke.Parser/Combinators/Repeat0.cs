...
{
    /// <summary>
    /// Uses a parser to parse 0 of more occurrences of an item.
    /// </summary>
    /// <typeparam name="TResult">The result type of a sub-parser.</typeparam>
    public class Repeat0<TResult> : IParser<IReadOnlyList<TResult>>
    {
        /// <summary>
        /// The item parser.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Repeat0{TResult}"/> class.
        /// </summary>
        /// <param name="item">The item parser.</param>
        public Repeat0(IParser<TResult> item)
        {
            this.Item = item;
        }
        ...
        public ParseResult<IReadOnlyList<TResult>> ParsePeek<TItem>(IPeekableStream<TItem> stream, int offset)
        {
            ...
            return ParseResult.Ok((IReadOnlyList<TResult>)result, offset, error);
        }
    }
}
